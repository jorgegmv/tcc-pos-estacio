...
def gera_grafico(df):
    # Ajusta os valores no Dataframe e filtra por Mortes
    df1 = df[['evolucao', 'nu_idade_n']].query('evolucao == 2 or evolucao == 3')
    del df1['evolucao']
    df1 = df1.dropna()
    df1.columns = ['Idade (Total de Óbitos)']
    # Monta e gera o gráfico.
    # df1.plot.box()
    color = {"boxes": "DarkGreen", "whiskers": "DarkOrange", "medians": "DarkBlue", "caps": "Gray"}
    ax = df1.plot.box(color=color, sym="r+")
    fig = ax.get_figure()
    fig.savefig("C:/Users/jorge/Downloads/Imagens/10_grafico_boxplot.png")
    plt.show()
